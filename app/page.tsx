              ...
              <div className="space-y-4">
                ...
                <div className="mt-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <a href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(defaultUrl)}&text=${encodeURIComponent("Track your dreams with Dreamwise - AI-powered dream journaling")}`} target="_blank" rel="noopener noreferrer" className="opacity-50 hover:opacity-100 transition-opacity">
                    ...
                    <a href={`viber://forward?text=${encodeURIComponent("Track your dreams with Dreamwise - AI-powered dream journaling " + defaultUrl)}`} target="_blank" rel="noopener noreferrer" className="opacity-50 hover:opacity-100 transition-opacity">
                    ...
                    <a href={`https://t.me/share/url?url=${encodeURIComponent(defaultUrl)}&text=${encodeURIComponent("Track your dreams with Dreamwise - AI-powered dream journaling")}`} target="_blank" rel="noopener noreferrer" className="opacity-50 hover:opacity-100 transition-opacity">
