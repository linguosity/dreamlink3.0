              ...
              <div className="space-y-4">
                ...
                <div className="mt-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <a href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(defaultUrl)}&text=${encodeURIComponent("Track your dreams with DreamRiver - AI-powered dream journaling")}`} target="_blank" rel="noopener noreferrer" aria-label="Share on X (Twitter)" className="inline-flex items-center justify-center w-11 h-11 rounded-full opacity-50 hover:opacity-100 transition-opacity">
                    ...
                    <a href={`viber://forward?text=${encodeURIComponent("Track your dreams with DreamRiver - AI-powered dream journaling " + defaultUrl)}`} target="_blank" rel="noopener noreferrer" aria-label="Share on Viber" className="inline-flex items-center justify-center w-11 h-11 rounded-full opacity-50 hover:opacity-100 transition-opacity">
                    ...
                    <a href={`https://t.me/share/url?url=${encodeURIComponent(defaultUrl)}&text=${encodeURIComponent("Track your dreams with DreamRiver - AI-powered dream journaling")}`} target="_blank" rel="noopener noreferrer" aria-label="Share on Telegram" className="inline-flex items-center justify-center w-11 h-11 rounded-full opacity-50 hover:opacity-100 transition-opacity">
