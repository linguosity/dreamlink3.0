  ...
  return (
    <div className="container py-6 sm:py-10 relative">
      ...
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-10 relative z-10">
        ...
        <h1 className="sr-only">Dreamwise Dream Journal</h1>
        ...
        <footer className="border-t pt-8 mt-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div>
              <h3 className="font-bold text-lg mb-3 text-gray-900 dark:text-gray-100">Dreamwise</h3>
            ...
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li><Link href="/help" className="no-brand-style inline-flex items-center min-h-[44px] text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white hover:underline transition-colors">Help</Link></li>
                <li><Link href="/about" className="no-brand-style inline-flex items-center min-h-[44px] text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white hover:underline transition-colors">About</Link></li>
                <li><Link href="/privacy" className="no-brand-style inline-flex items-center min-h-[44px] text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white hover:underline transition-colors">Privacy Policy</Link></li>
                <li><Link href="/terms" className="no-brand-style inline-flex items-center min-h-[44px] text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white hover:underline transition-colors">Terms of Service</Link></li>
              </ul>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="mt-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <a href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(defaultUrl)}&text=${encodeURIComponent("Track your dreams with Dreamwise - AI-powered dream journaling")}`} target="_blank" rel="noopener noreferrer" aria-label="Share on X (Twitter)" className="inline-flex items-center justify-center w-11 h-11 rounded-full opacity-50 hover:opacity-100 transition-opacity">
                    ...
                    <a href={`viber://forward?text=${encodeURIComponent("Track your dreams with Dreamwise - AI-powered dream journaling " + defaultUrl)}`} target="_blank" rel="noopener noreferrer" aria-label="Share on Viber" className="inline-flex items-center justify-center w-11 h-11 rounded-full opacity-50 hover:opacity-100 transition-opacity">
                    ...
                    <a href={`https://t.me/share/url?url=${encodeURIComponent(defaultUrl)}&text=${encodeURIComponent("Track your dreams with Dreamwise - AI-powered dream journaling")}`} target="_blank" rel="noopener noreferrer" aria-label="Share on Telegram" className="inline-flex items-center justify-center w-11 h-11 rounded-full opacity-50 hover:opacity-100 transition-opacity">
          ...
          <div className="text-center text-xs text-gray-600 dark:text-gray-400 mt-8 pt-4 border-t border-gray-200 dark:border-gray-700 space-y-1">
            <p>&copy; {new Date().getFullYear()} Dreamwise. All rights reserved.</p>
            <p>
